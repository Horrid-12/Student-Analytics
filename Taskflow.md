...
- [ ] 3.7 Auth gate per spec below — **DEFERRED 2026-08-29 (team decision):** ship the Vercel switch polished first; revisit as a dedicated post-cutover feature (folded into Phase 4). Until then the `badge-purple">Faculty` chip is a static placeholder. Spec G–K below stays as the reference.
