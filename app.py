    ...
    with left:
        ...
        table_event = st.dataframe(
            ...
            column_config={
                ...
                "Following_Per_Account_Year": st.column_config.NumberColumn("Following per Account-Year", format="%.2f"),
                "Username_Changed": st.column_config.CheckboxColumn("Username Changed"),
            },
        )
